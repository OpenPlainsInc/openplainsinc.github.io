...
::: {.callout-note}
This page is the workshop snapshot from FOSS4G NA 2024. The maintained,
up-to-date version of this material is the
[Introduction to Actinia tutorial](../../notebooks/actinia/basics_actinia.qmd).
:::
