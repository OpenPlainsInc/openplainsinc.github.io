...
[![Open in Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/OpenPlainsInc/openplainsinc.github.io/blob/main/content/notebooks/actinia/_basics_actinia.ipynb)
...
print_as_json(response.json().get('projects'))
```
...
Let move on to creating process chains in [Part 3](../../workshops/foss4gna_2024/process_chains.ipynb).
