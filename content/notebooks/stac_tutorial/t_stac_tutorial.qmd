...
gs.run_command(
    ...
    method="follows",
    expression=(
        "float(if('sentinel_2.nir' >= 10000.0, 10000.0, 'sentinel_2.nir') - if('sentinel_2.red' >= 10000.0, 10000.0, 'sentinel_2.red')) / (if('sentinel_2.nir' >= 10000.0, 10000.0, 'sentinel_2.nir') + if('sentinel_2.red' >= 10000.0, 10000.0, 'sentinel_2.red'))"
    ),
    overwrite=True,
    flags="n",
)
