...
format:
    revealjs:
        ...
        footer: "OpenPlains · FOSS4G NA 2024"
        progress: true
        controls: false
        transition: fade
...
- c-corp?
- non-profit?
![](../../images/logos/openplains-logo.svg)
...
## Part 2. Open Source as an Economic Driver
...
:::
:::{.column width=50%}
[![Link to Full Image](../images/Map%20of%20Geospatial%20Platforms%202.png)](../images/Map%20of%20Geospatial%20Platforms%202.png)
:::
:::
...
:::{.columns}
:::{.column width=50%}
![](../../images/logos/grassgis_logo_colorlogo_text_whitebg.png){width="62%" .no-shadow}
:::
:::{.column width=50%}
